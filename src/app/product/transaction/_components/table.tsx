...
import { useLazyGetAllQuery } from "@/store/services/transaction";
...
export const columns: ColumnDef<ITransaction>[] = [
    {
        ...
        header: "Type",
        cell: ({ row }) => <div className="uppercase">{row.getValue("transaction_type")}</div>,
    },
    {
        accessorKey: "name",
        header: "Name",
    ...
    },
    {
        ...
        header: "Product",
        cell: ({ row }) => (
            <div className="">{row.getValue("productId")}</div>
        ),
    },
    {
