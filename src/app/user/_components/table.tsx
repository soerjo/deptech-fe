...
export const columns: ColumnDef<GetUserResponse>[] = [
    {
        ...
        header: "Nama Lengkap",
        cell: ({ row }) => <div className="lowercase">{`${row.original.first_name} ${row.original.last_name}`}</div>,
    },
    {
        accessorKey: "email",
        header: "Email",
    ...
    },
    {
        ...
        header: "Birthday",
        cell: ({ row }) => <div className="lowercase">{new Date(row.getValue("birthday")).toLocaleDateString()}</div>,
    },
